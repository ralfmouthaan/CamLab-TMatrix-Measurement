...
This program allows a random hologram, a pre-calculated hologram, or a binary Spade/Club/Heart/Diamond hologram to be displayed, and the corresponding output field to be recorded. This can be used for testing purposes.
